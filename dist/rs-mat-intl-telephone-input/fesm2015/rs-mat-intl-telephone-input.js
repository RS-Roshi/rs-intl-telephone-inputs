import { ɵɵdefineInjectable, ɵsetClassMetadata, Injectable, ɵɵdefinePipe, Pipe, ɵɵelementStart, ɵɵtext, ɵɵelementEnd, ɵɵnextContext, ɵɵadvance, ɵɵtextInterpolate1, ɵɵgetCurrentView, ɵɵlistener, ɵɵrestoreView, ɵɵproperty, ɵɵreference, ɵɵelement, ɵɵtemplate, ɵɵtextInterpolate2, ɵɵelementContainerStart, ɵɵpipe, ɵɵelementContainerEnd, ɵɵpipeBind2, EventEmitter, ɵɵdirectiveInject, ElementRef, ɵɵdefineComponent, ɵɵviewQuery, ɵɵqueryRefresh, ɵɵloadQuery, ɵɵhostProperty, ɵɵclassProp, ɵɵProvidersFeature, ɵɵInheritDefinitionFeature, Component, Optional, Self, Input, ViewChild, HostBinding, Output, ɵɵdefineNgModule, ɵɵdefineInjector, ɵɵsetNgModuleScope, NgModule } from '@angular/core';
import { MatFormFieldControl } from '@angular/material/form-field';
import { NgControl, NgForm, FormGroupDirective, NG_VALIDATORS, DefaultValueAccessor, NgControlStatus, NgModel, FormsModule, ReactiveFormsModule } from '@angular/forms';
...
class RsMatIntlTelephoneInputService {
    constructor() { }
}
...
RsMatIntlTelephoneInputService.ɵprov = ɵɵdefineInjectable({ token: RsMatIntlTelephoneInputService, factory: RsMatIntlTelephoneInputService.ɵfac, providedIn: 'root' });
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵsetClassMetadata(RsMatIntlTelephoneInputService, [{
        type: Injectable,
        args: [{
                providedIn: 'root'
            }]
...
SearchPipe.ɵpipe = ɵɵdefinePipe({ name: "search", type: SearchPipe, pure: true });
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵsetClassMetadata(SearchPipe, [{
        type: Pipe,
        args: [{
                name: 'search'
            }]
...
function RsMatIntlTelephoneInputComponent_span_3_Template(rf, ctx) { if (rf & 1) {
...
function RsMatIntlTelephoneInputComponent_input_6_Template(rf, ctx) { if (rf & 1) {
    const _r8 = ɵɵgetCurrentView();
    ɵɵelementStart(0, "input", 12);
    ɵɵlistener("ngModelChange", function RsMatIntlTelephoneInputComponent_input_6_Template_input_ngModelChange_0_listener($event) { ɵɵrestoreView(_r8); const ctx_r7 = ɵɵnextContext(); return ctx_r7.searchCriteria = $event; })("click", function RsMatIntlTelephoneInputComponent_input_6_Template_input_click_0_listener($event) { return $event.stopPropagation(); });
    ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r2 = ɵɵnextContext();
    ɵɵproperty("ngModel", ctx_r2.searchCriteria)("placeholder", ctx_r2.searchPlaceholder);
} }
function RsMatIntlTelephoneInputComponent_button_7_span_5_Template(rf, ctx) { if (rf & 1) {
...
function RsMatIntlTelephoneInputComponent_button_7_Template(rf, ctx) { if (rf & 1) {
    const _r14 = ɵɵgetCurrentView();
    ɵɵelementStart(0, "button", 13);
    ɵɵlistener("click", function RsMatIntlTelephoneInputComponent_button_7_Template_button_click_0_listener() { ɵɵrestoreView(_r14); const country_r10 = ctx.$implicit; const ctx_r13 = ɵɵnextContext(); const _r6 = ɵɵreference(11); return ctx_r13.onCountrySelect(country_r10, _r6); });
    ɵɵelementStart(1, "div", 14);
    ɵɵelement(2, "div", 15);
    ɵɵelementEnd();
    ɵɵelementStart(3, "div", 16);
    ɵɵtext(4);
    ɵɵtemplate(5, RsMatIntlTelephoneInputComponent_button_7_span_5_Template, 2, 1, "span", 7);
    ɵɵelementEnd();
    ɵɵelementEnd();
} if (rf & 2) {
...
function RsMatIntlTelephoneInputComponent_mat_divider_8_Template(rf, ctx) { if (rf & 1) {
    ɵɵelement(0, "mat-divider");
} }
function RsMatIntlTelephoneInputComponent_ng_container_9_button_1_Template(rf, ctx) { if (rf & 1) {
    const _r19 = ɵɵgetCurrentView();
    ɵɵelementStart(0, "button", 13);
    ɵɵlistener("click", function RsMatIntlTelephoneInputComponent_ng_container_9_button_1_Template_button_click_0_listener() { ɵɵrestoreView(_r19); const country_r15 = ɵɵnextContext().$implicit; const ctx_r17 = ɵɵnextContext(); const _r6 = ɵɵreference(11); return ctx_r17.onCountrySelect(country_r15, _r6); });
    ɵɵelementStart(1, "div", 14);
    ɵɵelement(2, "div", 15);
    ɵɵelementEnd();
    ɵɵelementStart(3, "div", 16);
...
function RsMatIntlTelephoneInputComponent_ng_container_9_Template(rf, ctx) { if (rf & 1) {
    ɵɵelementContainerStart(0);
    ɵɵtemplate(1, RsMatIntlTelephoneInputComponent_ng_container_9_button_1_Template, 5, 3, "button", 17);
    ɵɵpipe(2, "search");
...
class RsMatIntlTelephoneInputComponent extends _NgxMatIntlTelInputMixinBase {
    ...
    _defaultErrorStateMatcher) {
        ...
        this.focused = false;
        this.id = `rs-mat-intl-telephone-input-${RsMatIntlTelephoneInputComponent.nextId++}`;
        this.describedBy = '';
        this.phoneNumber = '';
        this.allCountries = [];
...
RsMatIntlTelephoneInputComponent.ɵfac = function RsMatIntlTelephoneInputComponent_Factory(t) { return new (t || RsMatIntlTelephoneInputComponent)(ɵɵdirectiveInject(CountryCode), ɵɵdirectiveInject(FocusMonitor), ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(NgControl, 10), ɵɵdirectiveInject(NgForm, 8), ɵɵdirectiveInject(FormGroupDirective, 8), ɵɵdirectiveInject(ErrorStateMatcher)); };
RsMatIntlTelephoneInputComponent.ɵcmp = ɵɵdefineComponent({ type: RsMatIntlTelephoneInputComponent, selectors: [["rs-mat-intl-telephone-input"]], viewQuery: function RsMatIntlTelephoneInputComponent_Query(rf, ctx) { if (rf & 1) {
        ɵɵviewQuery(MatMenu, 1);
    } if (rf & 2) {
        let _t;
        ɵɵqueryRefresh(_t = ɵɵloadQuery()) && (ctx.matMenu = _t.first);
    } }, hostVars: 3, hostBindings: function RsMatIntlTelephoneInputComponent_HostBindings(rf, ctx) { if (rf & 2) {
        ɵɵhostProperty("id", ctx.id);
        ɵɵclassProp("ngx-floating", ctx.shouldLabelFloat);
    } }, inputs: { preferredCountries: "preferredCountries", enablePlaceholder: "enablePlaceholder", inputPlaceholder: "inputPlaceholder", cssClass: "cssClass", name: "name", onlyCountries: "onlyCountries", errorStateMatcher: "errorStateMatcher", enableSearch: "enableSearch", searchPlaceholder: "searchPlaceholder", format: "format", placeholder: "placeholder", required: "required", disabled: "disabled" }, outputs: { countryChanged: "countryChanged" }, features: [ɵɵProvidersFeature([
            CountryCode,
        ...
        ɵɵelement(2, "span", 2);
        ɵɵtemplate(3, RsMatIntlTelephoneInputComponent_span_3_Template, 2, 1, "span", 3);
        ɵɵelementEnd();
        ɵɵelementStart(4, "mat-menu", null, 4);
        ɵɵtemplate(6, RsMatIntlTelephoneInputComponent_input_6_Template, 1, 2, "input", 5);
        ɵɵtemplate(7, RsMatIntlTelephoneInputComponent_button_7_Template, 6, 3, "button", 6);
        ɵɵtemplate(8, RsMatIntlTelephoneInputComponent_mat_divider_8_Template, 1, 0, "mat-divider", 7);
        ɵɵtemplate(9, RsMatIntlTelephoneInputComponent_ng_container_9_Template, 3, 4, "ng-container", 8);
        ɵɵelementEnd();
        ɵɵelementStart(10, "input", 9, 10);
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵsetClassMetadata(RsMatIntlTelephoneInputComponent, [{
        ...
        args: [{
    ...
    }], function () { return [{ type: CountryCode }, { type: FocusMonitor }, { type: ElementRef }, { type: NgControl, decorators: [{
                type: Optional
            }, {
                type: Self
                ...
                type: Optional
            }] }, { type: ErrorStateMatcher }]; }, { preferredCountries: [{
            type: Input
        }], enablePlaceholder: [{
            type: Input
        }], inputPlaceholder: [{
...
class RsMatIntlTelephoneInputModule {
}
RsMatIntlTelephoneInputModule.ɵmod = ɵɵdefineNgModule({ type: RsMatIntlTelephoneInputModule });
RsMatIntlTelephoneInputModule.ɵinj = ɵɵdefineInjector({ factory: function RsMatIntlTelephoneInputModule_Factory(t) { return new (t || RsMatIntlTelephoneInputModule)(); }, imports: [[
            CommonModule,
            FormsModule,
            MatInputModule,
            MatMenuModule,
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵɵsetNgModuleScope(RsMatIntlTelephoneInputModule, { declarations: [RsMatIntlTelephoneInputComponent, SearchPipe], imports: [CommonModule,
        FormsModule,
        MatInputModule,
        MatMenuModule,
        MatButtonModule,
        MatDividerModule,
        ReactiveFormsModule], exports: [RsMatIntlTelephoneInputComponent] }); })();
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵsetClassMetadata(RsMatIntlTelephoneInputModule, [{
        type: NgModule,
        args: [{
...
export { RsMatIntlTelephoneInputComponent, RsMatIntlTelephoneInputModule, RsMatIntlTelephoneInputService };
//# sourceMappingURL=rs-mat-intl-telephone-input.js.map
